...
2.5	AUG 1988	Fixed a bug in the command line parser that puts it
       ...
       Aug 2010   Turbo C needed a dummy variable here to do extern right HRJ
     May 2017   binary out file HRJ
     Mar 2018   Added SCRT pseudo ops "CALL" and "RETN". L. Christensen.

2.6  Jun 2021	HRJ .0, .1 high low notation
...
#define	BINOPEN		"Binary File Did Not Open"
...
#define BINNEG		"Binary file Address Backward"
...
#define	TITL		16
#define	WORD		17
#define	CALL		18		/* loren: SCRT call subroutine  */
#define	RETN		19		/*        SCRT return from subroutine */
#define FILL		20 		/* fill value for number of byte HRJ */
...
#define	ADDIT		0x0200	/*  binary +, binary -	.hi .lo HRJ		*/
#define	RELAT		0x0300	/*  >, >=, =, <=, <, <>			*/
...
/* #define	HILO		0x0c00	/*  value.1 value.0 high low HRJ */
...
/*  Utility package (A18UTIL.C) bin file output routines:		*/
